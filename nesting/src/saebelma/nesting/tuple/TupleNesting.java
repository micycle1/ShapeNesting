package saebelma.nesting.tuple;
...
import saebelma.nesting.geometry.*;
import saebelma.nesting.geometry.elements.*;
import saebelma.nesting.geometry.elements.Vector;
import saebelma.nesting.irregular.*;
import saebelma.nesting.irregular.NestingCriterion.Result;
import saebelma.nesting.svg.*;
import saebelma.nesting.svg.SVG.Style;

/**
 * Implementation of hybrid saebelma.nesting strategy. Polygons are first nested into pairs and quadruples.
 * Quadruples are nested into an larger arrangement of polygons on which a two-dimensional search
 * using the table area is performed. Different saebelma.nesting criteria can be used for pairs, quadruples
...
public class TupleNesting implements Drawable {
    ...
    /**
     * Constructs and runs an instance of the tuple saebelma.nesting algorithm for the given polygon.
     * 
    ...
    /**
     * Returns an <code>EnumMap</code> of the polygon sets in this saebelma.nesting, indexed by polygon set type.
     * 
     * @return an <code>EnumMap</code> of the polygon sets in this saebelma.nesting
     */
    ...
    /**
     * Returns an <code>EnumMap</code> of the search spaces in this saebelma.nesting, indexed by search space
     * type.
     * 
     * @return an <code>EnumMap</code> of the search spaces in this saebelma.nesting
     */
    ...
    /**
     * Returns the number of polygons in the best saebelma.nesting result.
     * 
     * @return the number of polygons in the best saebelma.nesting result
     */
    public int getN() {
     ...
     * for saebelma.nesting pairs; otherwise an instance of <code>ConvexHullCriterion</code> is used. The default
     ...
     *                                                    is used for saebelma.nesting pairs; otherwise an
    ...
    /**
     * If set to <code>true</code> an instance of <code>SmallestEnclosingCircleCriterion</code> is used
     * for saebelma.nesting quadruples; otherwise an instance of <code>ConvexHullCriterion</code> is used. The
     ...
     *                                                         <code>SmallestEnclosingCircleCriterion</code>
     *                                                         is used for saebelma.nesting quadruples; otherwise
     *                                                         an instance of
    ...
    /**
     * Implements a search space for saebelma.nesting polygons or polygon sets.
     */
    ...
    /**
     * The types of search spaces used in tuple saebelma.nesting.
     */
    ...
    /**
     * The types of relative positions of oriented polygons and polygon pairs used in tuple saebelma.nesting.
     */
    ...
    /**
     * The types of polygon sets (singles, pairs, quadruples) used in tuple saebelma.nesting.
     */
    ...
    /**
     * The different types of larger arrangements used in tuple saebelma.nesting.
     */
    public enum NestingType {
        ...
        /**
         * The saebelma.nesting result for the given type of arrangement.
         */
        ...
        /**
         * Constructs a type of arrangement used in tuple saebelma.nesting.
         * 
    ...
    /**
     * A search result of the tuple saebelma.nesting algorithm.
     */
    ...
    /**
     * Returns an svg element representing the best tuple saebelma.nesting result graphically.
     */
    @Override
