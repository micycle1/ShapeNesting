...
import saebelma.nesting.geometry.elements.Polygon;
...
import saebelma.nesting.svg.Drawable;
import saebelma.nesting.svg.SVG;
import saebelma.nesting.svg.SVG.Style;
import saebelma.nesting.tuple.TupleNesting;

/**
 * A simple GUI application demonstrating various packing and saebelma.nesting algorithms.
 */
public class GUI extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // Create radio buttons and toggle group for irregular shape saebelma.nesting criterion selection
        ...
        // Create radio buttons and toggle groups for tuple saebelma.nesting criterion selection
    ...
    private void irregularShapeNesting() {
        ...
        // Perform irregular shape saebelma.nesting
        startTimer();
        ...
        // Display in text area
        textArea.appendText(
                "Irregular shape saebelma.nesting in  " + elapsedTimeInMS + " ms\n");
    ...
    private void tupleNesting() {
        ...
        // Display in text area
        textArea.appendText("Tuple saebelma.nesting in  " + elapsedTimeInMS + " ms\n");
