package saebelma.nesting.geometry.elements;
...
import saebelma.nesting.util.CircularArrayList;
import saebelma.nesting.util.CircularList;

/**
 * A plane figure that is described by a finite number of straight line segments connected to form a
 * closed polygonal chain. For the purposes of saebelma.nesting, polygons should be simple and the vertices
...
public class Polygon implements Drawable {
     ...
     * {@link saebelma.nesting.geometry.elements.LineSegment#doIntersect(List, List)}.
     * 
     ...
     * the polygon. See
     * {@link saebelma.nesting.geometry.elements.DirectedLineSegment#isLeftOf(Point, DirectedLineSegment)}.
     * 
     * @param point a point
     * @return <code>true</code> if this polygon contains the given integer point
     */
