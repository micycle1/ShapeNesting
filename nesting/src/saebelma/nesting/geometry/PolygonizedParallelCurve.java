package saebelma.nesting.geometry;
...
import saebelma.nesting.irregular.NestingParameters;
import saebelma.nesting.util.CircularArrayList;
import saebelma.nesting.util.CircularList;

/**
 * This is a polygonized version of {@link saebelma.nesting.geometry.ParallelCurve}. Many packages simply
 * choose points on the curve for polygonization, but in order to maintain the required minimum
 * distance for saebelma.nesting, we have be careful to calculate <i>tangents</i> to the arcs.
 * 
