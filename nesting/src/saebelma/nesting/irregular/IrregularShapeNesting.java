package saebelma.nesting.irregular;

import static saebelma.nesting.irregular.NoFitSpace.*;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import saebelma.nesting.geometry.OffsetCurve;
import saebelma.nesting.geometry.elements.*;
import saebelma.nesting.svg.*;
import saebelma.nesting.svg.SVG.Style;

/**
 * A simple implementation of irregular shape saebelma.nesting in a circular area. Instances of a polygon are
 ...
 * saebelma.nesting criterion. The algorithm works by initializing and updating two instances of
...
public class IrregularShapeNesting implements Drawable {
    ...
    /**
     * Constructs a simple irregular shape saebelma.nesting algorithm for the given polygon.
     * 
    ...
    public IrregularShapeNesting(Polygon polygon) {
        ...
        // Get saebelma.nesting criterion
